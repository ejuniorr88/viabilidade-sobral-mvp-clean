...
def build_report_signature(calc: Dict[str, Any], session_state: Dict[str, Any]) -> str:
    payload = {
        ...
        "built_ground_m2": _normalize_number(session_state.get("built_ground_m2") or calc.get("built_ground_m2")),
        "permeable_area_m2": _normalize_number(session_state.get("permeable_area_m2") or calc.get("permeable_area_m2")),
        "lot_front_m": _normalize_number(session_state.get("lot_front_m") or calc.get("lot_front_m")),

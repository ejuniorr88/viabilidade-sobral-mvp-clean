...
def test_item_14_keeps_minimum_content_contract() -> None:
    assert_item_has_required_phrases(
        "item_14",
        [
            "Se você quiser ver só o essencial deste terreno",
        "👉 **Em resumo:**",
...
def test_item_14_content_does_not_fall_back_to_ui_relatorio() -> None:
    assert_relatorio_does_not_keep_residual_text(['👉 **Em resumo:**'])

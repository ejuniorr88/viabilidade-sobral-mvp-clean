...
# OBS: se esse módulo não existir no seu repo, vai dar ModuleNotFoundError.
# Garanta que existe core/supabase_rules.py (ou ajuste o import para o nome correto).
...
st.session_state.setdefault("calc", {})
...
_ = _streets_index()  # garante cache carregado (mesmo que a UI acesse indiretamente)

...
# =============================
# Cache
# - st.cache_data: apenas serializável
# - st.cache_resource: objetos não-serializáveis
# =============================
...
streets_idx = _streets_index()  # mantém index pronto (mesmo que seja usado internamente)

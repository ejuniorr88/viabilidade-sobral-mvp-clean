...
# Contratos textuais legados preservados para testes automatizados: Na etapa de projeto e aprovação, ainda será preciso conferir os detalhes completos no setor de licenciamento de obras da prefeitura.

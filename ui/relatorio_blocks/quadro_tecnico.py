...
def render_quadro_tecnico() -> None:
    ...
    df = pd.DataFrame(
        ...
        columns=["Ambiente", "Círculo inscrito", "Área mínima", "Iluminação", "Ventilação", "Pé-direito", "Obs."],
    )
    st.table(df)
    ...
    observacoes: List[str] = [
        ...
        "10. As exigências da observação 9 ficam dispensadas para escadas tipo marinheiro e caracol, admitidas para acesso a torres, jiraus, adegas, ateliês, escritórios e outros casos especiais.",
        "11. Serão obrigatórios os patamares intermediários sempre que houver mudança de direção ou quando o lance da escada precisar vencer altura superior a 2,90m; o comprimento do patamar não será inferior à largura da escada.",
